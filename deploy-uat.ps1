...
## Author Theo Xavier
## Edited 3/4/2019
$currentWebAppDirectory = "//lfkqbwtweb02/c$/inetpub/wwwroot/docunex-uat/"
$backupWebAppDirectory = "//lfkqbwtweb02/c$/inetpub/wwwroot/backup/docunex-uat-backup/"
$temporaryDeployFolder = "//lfkqbwtweb02/c$/inetpub/wwwroot/deploy-docunex-uat"
## The $sourceTemporaryDeployFolder is the same as $temporaryDeployFolder except it has a '*' on the end.
$sourceTemporaryDeployFolder = "//lfkqbwtweb02/c$/inetpub/wwwroot/deploy-docunex-uat/*"
$baseHref = "docunex-uat"
$webConfig = "Web.uat.config"
$distInnerFolder = "dist\docunex"

## Build the project.
ng build --base-href=/$baseHref/ --configuration=uat
## Edit this --------------------------^
