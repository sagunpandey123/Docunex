...
export class PagesComponent implements OnInit {
  ...
  searchFromList: any[] = [
    { name: 'Lfkbwtfeng', value: 'plantdrawings'},
    { name: 'WPC-backup', value: 'scanneddocs'},
    { name: 'CCFISS', value: 'scada'}
    ];
  ...
  search(searchText) {
    ...
    this.dataService.getResults(searchText, this.searchByArray.value, this.searchFromArray.value).subscribe(entity => {
      this.result = entity;
